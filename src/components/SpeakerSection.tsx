...
export default function SpeakersSection() {
  ...
  return (
    <section class="flex flex-1 flex-col items-center justify-center min-h-screen bg-black text-white px-4 sm:px-8 p-5 relative">
      <h1 class="absolute text-tedx-red/40 inset-0 text-[50rem] flex justify-center items-center ">X</h1>
      ...
      <div class="card-container w-full flex flex-wrap  justify-center max-w-screen-xl">
        {speakers.map((speaker, index) => (
          <div class="card bg-[#FBF7ED] text-black p-1 transition-transform duration-500 aspect-square w-28 md:w-60 space-y-2 rounded-lg shadow-lg">
            <img
              src={speaker.image}
              alt={speaker.name}
